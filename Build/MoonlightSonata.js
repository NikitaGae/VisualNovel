...
(function (VisualNovel) {
    async function chapterSeven() {
        ...
        if (VisualNovel.dataForSave.saraScore < 100) {
            ...
            await VisualNovel.ƒS.Location.show(VisualNovel.locations.endChapterOne);
            await VisualNovel.ƒS.Text.print("<div class='newspaper'><h1>Junge Dame verfällt ihrer <br> Krankheit welche ihren Körper  <br> schwächt nachdem sie an einem  <br> Konzert in voller Länge gespielt  <br> hat</h1></div>");
